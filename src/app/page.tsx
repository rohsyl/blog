...
export default function Home() {
  ...
  return (
      <>
          <BackgroundLines className="md:-mt-30 flex items-center justify-center w-full flex-col px-4">
              ...
              <div className="flex">
                  <div className="grow text-center font-light text-gray-500 sm:text-xl dark:text-gray-400">
          ...
          <Container>
              ...
              <div className="mx-auto max-w-(--breakpoint-sm) text-center lg:mb-16 mb-8">
