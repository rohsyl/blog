        ...
        <footer className="p-4 md:p-8 lg:p-10 font-mono">
            <div className="mx-auto text-center">
                ...
                <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
                    <li>
                        <Link href="https://github.com/rohsyl" className="mr-4 hover:underline md:mr-6 ">Github</Link>
                    </li>
                    <li>
                        <Link href="https://www.linkedin.com/in/sylvain-roh/" className="mr-4 hover:underline md:mr-6">LinkedIn</Link>
                    </li>
                </ul>
            ...
            <Link href="/" className="hover:underline ml-2">Sylvain Roh</Link>. All Rights Reserved.
          </span>
            </div>
