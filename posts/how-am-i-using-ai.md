...
Honestly, I think it’s a good thing. We should use every tool available to stay productive and competitive. Why not use the right tool for the right task?
Would you refuse to use a hammer to hammer a nail?
...
Honestly, I think that’s the best way to use it:
**use it to accelerate, not to replace understanding.**
...
* A tool named **dockit**, a wrapper around Laravel Sail with useful commands like `logstream`, `dev` (runs server + scheduler + queue), and automatic Sail installation
* A tool named **peek**, an improved version of `cat` with extras from `head`, `tail`, `less`, `grep` — with color highlighting, line numbers, and Git integration
* Many Bash scripts that make me more effective in the terminal
...
When I need to learn a new technology, I often start with AI.
I ask for a learning path, an overview, or explanations in simpler terms.
...
AI is **terrible** at writing complex, production-ready code.
It’s even worse when you treat it as documentation for a library or a framework.

It’s worth trying what it suggests, but when I see it’s not what I want, I go back to the only reliable source:

**official documentation.**
Still the best thing to do. Still a core skill every developer needs.

---

## Conclusion

Use AI as a tool — not as a crutch.
Know its strengths: speed, drafting, automation.
Know its weaknesses: correctness, context, real understanding.
